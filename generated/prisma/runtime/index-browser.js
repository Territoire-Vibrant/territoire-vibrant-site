...
const Ke = Object.getOwnPropertyNames
const Qe = Object.prototype.hasOwnProperty
const Ye = (e) => {
  throw TypeError(e)
}
const Oe = (e, n) => {
  for (const i in n) pe(e, i, { get: n[i], enumerable: !0 })
}
const xe = (e, n, i, t) => {
...
const ze = (e) => xe(pe({}, '__esModule', { value: !0 }), e)
const ne = (e, n, i) =>
...
const tn = () => !!globalThis.Deno
const rn = () => typeof globalThis.Netlify === 'object'
const sn = () => typeof globalThis.EdgeRuntime === 'object'
const on = () => {
  let e
...
const Me = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -V, maxE: V, crypto: !1 }
let Le
let Z
let w = !0
const fe = '[DecimalError] '
const $ = `${fe}Invalid argument: `
const Ie = `${fe}Precision limit exceeded`
const Ze = `${fe}crypto unavailable`
const Ue = '[object Decimal]'
const R = Math.floor
const C = Math.pow
const cn = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i
const ln = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i
const an = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i
const Be = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i
const D = 1e7
const m = 7
const dn = 9007199254740991
const hn = se.length - 1
const Ce = oe.length - 1
const h = { toStringTag: Ue }
...
h.comparedTo = h.cmp = function (e) {
  ...
  let r
  const o = this.d
  const u = (e = new this.constructor(e)).d
  const c = this.s
  const f = e.s
...
h.hyperbolicCosine = h.cosh = function () {
  ...
  for (let c, f = e, l = new o(8); f--; ) (c = s.times(s)), (s = u.minus(c.times(l.minus(c.times(l)))))
...
h.hyperbolicSine = h.sinh = function () {
  ...
  if (
    ...
    for (let o, u = new s(5), c = new s(16), f = new s(20); e--; )
...
h.precision = h.sd = function (e) {
  ...
  return this.d ? ((n = $e(this.d)), e && this.e + 1 > n && (n = this.e + 1)) : (n = Number.NaN), n
}
h.round = function () {
...
h.toPower = h.pow = function (e) {
  ...
  return (
    (i = C(+u, f)),
    (n = i === 0 || !Number.isFinite(i) ? R(f * (Math.log(`0.${b(u.d)}`) / Math.LN10 + u.e + 1)) : new c(`${i}`).e),
...
h.toString = function () {
  const n = this.constructor
  const i = L(this, this.e <= n.toExpNeg || this.e >= n.toExpPos)
...
function te(e, n, i) {
  for (let t, r = [0], s, o = 0, u = e.length; o < u; ) {
...
const k = (() => {
  ...
  function i(t, r, s, o) {
    for (let u = 0; s--; ) (t[s] -= u), (u = t[s] < r[s] ? 1 : 0), (t[s] = u * o + t[s] - r[s])
  ...
  return (t, r, s, o, u, c) => {
    ...
    let T
    let y
    const ee = t.constructor
    const he = t.s === r.s ? 1 : -1
    let O = t.d
    let S = r.d
    if (!O || !O[0] || !S || !S[0])
      return new ee(
        !t.s || !r.s || (O ? S && O[0] === S[0] : !S) ? Number.NaN : (O && O[0] === 0) || !S ? he * 0 : he / 0
      )
    for (
...
function Ve(e, n, i) {
  for (let t, r, s = new e(n[0]), o = 0; ++o < n.length; ) {
    if (((r = new e(n[o])), !r.s)) {
      s = r
      break
    }
...
function mn(e, n) {
  ...
  for (let r, s = new e(5), o = new e(16), u = new e(20); i--; )
  ...
  if (
    ...
    for (
      l = L(e),
        ...
        o >= 0 &&
          ((l = l.replace('.', '')), (d = new g(1)), (d.e = l.length - o), (d.d = te(L(d), 10, r)), (d.e = d.d.length)),
        a = te(l, 10, r),
        s = c = a.length;
      a[--c] === 0;
    )
